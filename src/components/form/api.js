...
return axios.get('http://localhost:3000/allProducts').then(response => {
    console.log('API response',response.data);
    return response.data;
}).catch(error => {
    console.error('API error', error);
...
return axios.post('http://localhost:3000/school/register', data).then(response => {
    console.log('API response',response.data);
    return response.data;
}).catch(error => {
    console.error('API error', error);
...
return axios.post('http://localhost:3000/school/login', data,  {
...
return axios.get('http://localhost:3000/school/current',
      {
        withCredentials: true
    }
).then(response => {
...
export function getAllSchool() {
    return axios.get('http://localhost:3000/school/allSchool').then((res) => {
        return res.data;
    }).catch((err) => {
...
export function getSchoolProducts(id) {
    return axios.get(`http://localhost:3000/school/${id}/products`).then((res) => {
        return res.data;
    }).catch((err) => {
...
export function getSchoolById(id) {
    return axios.get(`http://localhost:3000/school/detail/${id}`).then((res) => {
        return res.data;
    }).catch((err) => {
